		...
		return this.each(function() {
			...
			$(this).bind({
				...
				mousemove : function(e){
					...
					.php(getNote(newWidth) +' <span class="maxRate">/ '+opts.rateMax+'</span>');
				},
				mouseleave : function(){
				...
				click : function(e){
					...
					/** ONLY FOR THE DEMO, YOU CAN REMOVE THIS CODE **/
						$('.datasSent p').php('<strong>idBox : </strong>'+idBox+'<br /><strong>rate : </strong>'+rate+'<br /><strong>action :</strong> rating');
						$('.serverResponse p').php('<strong>Loading...</strong>');
					...
					$.post(opts.phpPath,{
						...
						function(data) {
							...
							{
								/** ONLY FOR THE DEMO, YOU CAN REMOVE THIS CODE **/
									$('.serverResponse p').php(data.server);
								/** END ONLY FOR THE DEMO **/

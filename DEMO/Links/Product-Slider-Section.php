                    ...
                    <div class="col-12">
                        <div class="section-content-gap">
                            <div class="secton-content">
                                <h3 class="section-title">منتجات حديثة </h3>
                                <p>احدث المنتجات المضافة </p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="product-default-single-item product-color--golden swiper-slide">
                                        <div class="image-box">
                                            <a href="product-details-default.php" class="image-link">
                                                ...
                                                <img src="../assets/images/product/default/home-1/default-<?php echo $i+1; ?>.jpg" alt="">
                                            </a>
                                            <div class="tag">
                                                <span>sale</span>
                                            </div>
                                        ...
                                        <div class="content">
                                            <div class="content-left">
                                                <h6 class="title"><a href="product-details-default.php">المنتج <?php echo $i; ?></a></h6>
    ...
    <!-- Start BEST SELLERS Product Default Slider Section -->
                    ...
                    <div class="col-12">
                        <div class="section-content-gap">
                            <div class="secton-content">
                                ...
                                <p>مجموعة من ابرز المنتجات طلبا ورواجا</p>
                            </div>
                        </div>
                    </div>
                </div>

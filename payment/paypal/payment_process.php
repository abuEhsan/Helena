...
include('../../Links/Setting.php');

$error_message = '';

//$statement = $dbh->prepare("SELECT * FROM tbl_settings WHERE id=1");
//$statement->execute();
//$result = $statement->fetchAll(PDO::FETCH_ASSOC);
//foreach ($result as $row) {
//	$paypal_email = $row['paypal_email'];
//} 
$paypal_email="tariq9829@gmail.com"
...
if (!isset($_POST["txn_id"]) && !isset($_POST["txn_type"])){
    ...
    $i=0;
    $statement = $pdo->prepare("SELECT * FROM tblproducts");
    $statement->execute();
    $result = $statement->fetchAll(PDO::FETCH_ASSOC);							
    foreach ($result as $row) {
    	$i++;

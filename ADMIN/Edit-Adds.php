...
//    $PTY=$_POST['TYPE']; 
    ...
    $PSB=$_POST['SB']; 
    $PSS=$_POST['SS'];
    $sql="UPDATE `tbladds` SET `title`=:TITLE,`price`=:PRICE,`option`=:OPTION,`submitbutton`=:SB,`Status`=:SS WHERE id=:aid";
...
<head>
  ...
  <title> <?php echo $CNAME." || "."   تحديث العرض  "; ?> </title>
  <!-- Favicons -->
...
<?php if($msg){ ?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
      ...
      <?php } ?>
    <div class="pagetitle" >
      <h1> <?php echo "تحديث بيانات الاعلان"; ?> </h1>
    </div><!-- End Page Title -->
    ...
    <section class="section"  >
      <div class="row" >
        <div class="col-lg-6" >
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">  <?php echo "أدخل بيانات الاعلان"; ?> </h5>

              <!-- General Form Elements -->
              <form method="post" action="" enctype="multipart/form-data">
<?php 
$id=intval($_GET['aid']);
$sql = "SELECT * FROM tbladds WHERE id=:aid";
$query = $dbh->prepare($sql);
$query->bindParam(':aid',$id,PDO::PARAM_INT);
$query->execute();
...
?>  
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" value="<?php echo htmlentities($_SESSION['ADMIN_NAME']);  ?>" disabled >
                  </div>
                </div>  
                <?php }?>
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label"><?php echo "عنوان الاعلان"; ?></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="TITLE"  value="<?php echo $result->title; ?>"   >
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label"><?php echo "سعر الاعلان"; ?></label>
                  <div class="col-sm-10">
...
<!--
                ...
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label"><?php echo "نوع الاعلان"; ?></label>
                  <div class="col-sm-10">
<?php
$free="مجانا";
$sale="بيع";
...
?>
                   <select class="form-select" aria-label="Default select example" name="TYPE" required>
                      <option  value="1"><?php echo $free ?></option>
                      <option  value="2"><?php echo $sale ?></option>
                      <option  value="3"><?php echo $munth ?></option>
                      <option  value="4"><?php echo $year ?></option>
                   </select>     
                  </div>
                </div>
-->
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label"><?php echo "مميزات العرض"; ?></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="OPTION"  value="<?php echo $result->option; ?> " >
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="SB" value="<?php echo $result->submitbutton; ?>" required>
                  </div>
                </div>

...
//        include("Link/languge.php"); 
    ...
    $PDC=$_POST['DC']; 
    $PSS=$_POST['SS'];
    $sql="INSERT INTO `tblproconditions`(`AdminID`, `Title`, `DescTitle`, `Text`, `Status`) VALUES ('".$_SESSION['ADMIN_ID']."',:NA,:DC,:ABU,:SS)" ; 
    ...
    if($lastInsertId)
    {
     ...
     //delete Service
            ...
            {
            $id=intval($_GET['PCid']);
            $sql="delete from tblproconditions where ID=:PCid ";
            $query = $dbh->prepare($sql);
            $query->bindParam(':PCid',$id,PDO::PARAM_INT);
            $query->execute();
            if($query){
              $msg="تم حذف البند بنجاح";  
            }else{
               $erorr="المعذرة، أحيانا تحدث أخطاء.. الرجاء المحاولة مجددا!";  
            }   
...
<head>
  ...
  <title> <?php echo $CNAME." || "."    إدارة سياسة الخصوصية  " ?> </title>
  <!-- Favicons -->
...
<?php if($msg){ ?>
    <div class="alert alert-success alert-dismissible fade show" role="alert">
      ...
      <?php } ?>
    <div class="pagetitle" >
      <h1> <?php echo "ادارة البنود وسياسة الاستخدام "; ?> </h1>
    </div><!-- End Page Title -->
    ...
    <section class="section"  >
      <div class="row" >
        <div class="col-lg-6" >
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">  <?php echo "أدخل بيانات البند"; ?> </h5>
              ...
              <form method="post" action="" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label"> <?php echo "إسم البند"; ?></label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="NA" placeholder="المسوقين" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label"><?php echo " عنوان عرض البند"; ?> </label>
                  <div class="col-sm-10">
                    <input class="form-control" type="text" id="validationDefault02" placeholder="عرض سياية استخدام المسوقين" name="DC">
                  </div>
                </div>
                  
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label"> <?php echo " المحتوى "; ?></label>
                  <div class="col-sm-10">
                    <did class="textarea">
                ...
                <div class="row mb-3">
                    <fieldset class="row mb-3">
                      <legend class="col-form-label col-sm-2 pt-0"><?php echo "صلاحية العرض  "; ?></legend>
                      <div class="col-sm-10">
            ...
            <div class="card-body">
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col"><?php echo " عنوان البند";?></th>
                    <th scope="col"><?php echo " وصف عرض البند ";?></th>
                    <th scope="col"><?php echo "حول البند";?></th>
                ...
                <tbody>
<?php 
$sql = "SELECT * FROM tblproconditions";
$query = $dbh->prepare($sql);
$query->execute();
...
{ 
    ...
    //Format Text About
     $FormatStr=substr(filter_var($result->Text, FILTER_SANITIZE_STRING), 0, 150);
    
?>  
                                                <tr>
                                                       <td><?php echo htmlentities($cnt);?></td>
                                                       <td><?php echo htmlentities($result->Title);?></td>
                                                       <td><?php echo htmlentities($result->DescTitle);?></td>
...
if($result->Status == '1'){
    ...
    echo"لا يتم عرضه في الموقع";
                                                        ...
                                                        ?></td>
                                                        <td>
                                                            <a href="Edit-Pro-Conditions.php?PCID=<?php echo htmlentities($result->ID);?>"><i class="bi bi-pencil-fill" title="<?php echo "تحديث الخدمة";?>"></i> </a>
                                                        </td>
                                                         <td>
                                                            <a href="Pro-Conditions.php?PCid=<?php echo htmlentities($result->ID);?>"><i class="bi bi-trash-fill" title="<?php echo "حذف السجل";?> "  onClick="return confirm('<?php echo "هل أنت متأكد من الحذف!";?>');"></i> </a>

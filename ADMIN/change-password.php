   ...
   header("Location: index.php"); 
    exit;
        ...
        if(isset($_POST['submit']))
        {
            ...
            //$PCONFIRMNEWPASSWORD=$_POST['CONFIRMNEWPASSWORD'];
            $PPS=$_POST['OLDPASSWORD'];  
            $sql = "SELECT Password FROM tbladmin WHERE  ID='".$_SESSION['ADMIN_ID']."'";
            ...
            if($query->rowCount() > 0)
            {
              foreach($results as $result)
              {
                  ...
                  if (password_verify($PPS, $result->Password)) {
                      
                        $PNEWPASSWORD=password_hash($_POST['NEWPASSWORD'], PASSWORD_DEFAULT);
                        $con="update tbladmin set Password='$PNEWPASSWORD' where ID='".$_SESSION['ADMIN_ID']."' ";
...
<body>
 ...
 <?php include("Link/sidebar.php"); ?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
   <h1><?php echo "الملف الشخصي / تحديث كلمة المرور";?> </h1>
    </div><!-- End Page Title -->
<?php if($msg){ ?>
            ...
            <div class="card-body pt-3">
              <!-- Bordered Tabs -->
                  ...
                  <form  method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label"><?php echo "كلمة المرور السابقة";?> </label>
                      <div class="col-md-8 col-lg-9">
                        <input name="OLDPASSWORD" type="password" class="form-control" id="OLDPASSWORD" value="">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label"><?php echo "كلمة المرور الجديدة"; ?> </label>
                      <div class="col-md-8 col-lg-9">

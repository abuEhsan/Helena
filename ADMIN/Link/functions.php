...
function ext_check($dbh,$allowed_ext,$my_ext) 
{
...
function get_ai_id($dbh,$tbl_name) 
{
	$statement = $dbh->prepare("SHOW TABLE STATUS LIKE '$tbl_name'");
	$statement->execute();

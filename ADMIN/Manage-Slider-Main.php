...
//        include("Link/languge.php"); 
    ...
    if(isset($_POST['submit']))
    {
        ...
        $PURL=$_POST['URL'];
        $PSS=$_POST['SS'];
        $sql="INSERT INTO `tblsliderown`(`Icon`, `name`, `about`, `buttonurl`, `Status`) VALUES (:ICON,:NA,:ABU,:URL,:SS)" ; 
     ...
     //delete students
            ...
            $sql="delete from tblsliderown where id=:sliid ";
            $query = $dbh->prepare($sql);
    ...
    <section class="section"  >
      <div class="row" >
        <div class="col-lg-6" >
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">  <?php echo "أدخل بيانات العارض الرئيسي "; ?> </h5>
              ...
              <form method="post" action="" enctype="multipart/form-data">
               ...
               <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="text" id="formFile" name="ICON" value="bi bi-bounding-box icon">
                  </div>
                </div>    
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
<?php 
$sql = "SELECT `id`, `Icon`, `name`, `about`, `buttonurl`, `Status` FROM `tblsliderown`;";
$query = $dbh->prepare($sql);
$query->execute();
...
if($result->Status == '1'){
    ...
    echo"لا يتم عرضه في الموقع";
                                                        ...
                                                        ?></td>
                                                            <td>
                                                                <a href="Edit-Slider-Main.php?sliid=<?php echo htmlentities($result->id);?>"><i class="bi bi-pencil-fill" title="<?php echo "تحديث المنتج";?>"></i> </a>
                                                            </td>
                                                         <td>
                                                            <a href="Manage-Slider-Main.php?sliid=<?php echo htmlentities($result->id);?>"><i class="bi bi-trash-fill" title="<?php echo "حذف السجل";?> "  onClick="return confirm('<?php echo "هل أنت متأكد من الحذف!";?>');"></i> </a>

    ...
    <div class="breadcrumb-section breadcrumb-bg-color--golden">
        <div class="breadcrumb-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="breadcrumb-title">تواصل معنا</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="contact-details-wrapper section-top-gap-100" data-aos="fade-up" data-aos-delay="0">
                        <div class="contact-details">
                            ...
                            <div class="contact-details-single-item">
                                ...
                                <div class="contact-details-content contact-phone" style="padding:2%;">
                        ...
                        <div class="contact-social">
                            <h4>عناوين التواصل الاجتماعي</h4>
                            <ul><?php 
...
?>
                                    <li style='margin-right: 1%;'><a href="<?php echo htmlentities($result->social_url);?>"><i class="<?php echo htmlentities($result->social_icon);?>"></i></a></li>
...
<?php }}} ?>
                ...
                <div class="col-lg-8">
                    <div class="contact-form section-top-gap-100" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <form id="" action="Links/Sent-Massage.php" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="default-form-box mb-20">
                                        <label for="contact-name">الأسم</label>
                                        <input name="name" type="text" id="contact-name" value="<?php 
                                                                                if(isset($_SESSION['customer']['cust_name'])){
                                ...
                                <div class="col-lg-6">
                                    <div class="default-form-box mb-20">
                                        <label for="contact-email">البريد</label>
                                        <input name="email" type="email" id="contact-email" value="<?php 
                                                                                if(isset($_SESSION['customer']['cust_email'])){
                                                                                    echo $_SESSION['customer']['cust_email'];
                                                                                }else{
                                                                                    echo"";
                                                                                }  ?>">
                                    </div>
                                ...
                                <div class="col-lg-12">
                                    <button class="btn btn-lg btn-black-default-hover"   name="submit">ارسال</button>

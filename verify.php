  ...
  if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        $statement = $dbh->prepare("UPDATE tblcustomer SET cust_token=?, cust_status=? WHERE cust_email=?");
        $statement->execute(array('',1,$_GET['email']));
        $success_message = '<p style="color:green;">تم التحقق من بريدك الالكتروني بنجاح. يمكنك تسجيل دخولك للموقع. </p><p><a href="'.$BASE_URL.'login.php" style="color:#167ac6;font-weight:bold;">أنقر لتسجيل الدخول</a></p>';    
